...
На данном занятии будет изучена программа работы с портами ввода/вывода общего назначения.

## Режим _Учебного стенда_ и функциональная схема

Для выполнения данной работы следует установить переключатели _S1_ и _S2_ в положение _0_ на учебном стенде.
