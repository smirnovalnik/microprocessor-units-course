...
int main(void)
{
    ...
    *pa = 4;
    ...
    /* Первая функция примает аргумент по значению и не изменяет 
    состояние этой переменно, вторая функция принимает аргумент через
    указатеь и изменяет значение аргуента*/
    add2(a);
    add2_ptr(&a);
