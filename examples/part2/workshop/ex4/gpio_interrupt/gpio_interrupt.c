/**
  ...
  *          При нажатии на кнопку SB1 включается светодиод D1.
...
/* Функция инициализации светодиода D1 */
void led1_init(void)
{
...
/* Функция включения светодиода D1 */
void led1_on(void)
{
   /* Включаем светодиод установкой в 1 бита 0 */
    GPIOC->ODR |= 1;
}

/* Функция отключения светодиода D1 */
void led1_off(void)
{
    /* Выключаем D1 сбросом в 0 бита 0 */
    GPIOC->ODR &= ~1;
}
