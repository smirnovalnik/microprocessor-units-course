...
Курс предназначен для студентов бакалавриата четвертого года обучения факультета электронной техники.
...
- Лабораторные работы
  ...
  - Лабораторная работа №2: Поиск элементов в массиве данных ([пример](./examples/part1/labs/lab2/))
