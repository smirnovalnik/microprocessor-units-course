...
- Практические занятия
  ...
  - Практическое занятие №6: Подсистема последовательного ввода/вывода МК: SPI
  - Практическое занятие №7: Подсистема последовательного ввода/вывода МК: UART
- Лабораторные работы
  - Лабораторная работа №1 Подсистема аналогового ввода/вывода МК
  - Лабораторная работа №2 Подсистема реального времени МК
  - Лабораторная работа №3 Подсистема последовательного ввода/вывода МК: SPI, UART, I2C
- Экзамен
...
- [examples](./examples/) - примеры лабораторных работ и задачи для практических занятий
  ...
  - [part2](./examples/part2/) - для второй части курса
    - [labs](./examples/part2/labs/) - примеры лабораторных работы
      ...
      - [lab1](./examples/part2/labs/lab2/) - пример задачи _Лабораторной работы №2 Подсистема реального времени МК_
      - [lab1](./examples/part2/labs/lab3/) - пример задачи _Лабораторной работы №3 Подсистема последовательного ввода/вывода МК: SPI, UART, I2C_
