...
- Практические занятия
  ...
  - Практическое занятие №4: Подсистема аналогового ввода/вывода МК ([пример](./examples/part2/workshop/ex4))
...
- [examples](./examples/) - примеры лабораторных работ и задачи для практических занятий
  ...
  - [part2](./examples/part2/) - для второй части курса
    - [labs](./examples/part2/labs/) - примеры лабораторных работ
      - [lab1](./examples/part2/labs/lab1/) - пример _Лабораторной работы №1 Язык программирования C_
      - [lab2](./examples/part2/labs/lab2/) - пример _Лабораторной работы №2 Подсистема аналогового ввода/вывода МК_
      - [lab3](./examples/part2/labs/lab3/) - пример _Лабораторной работы №3 Подсистема реального времени МК_
      - [lab4](./examples/part2/labs/lab4/) - пример _Лабораторной работы №4 Подсистема последовательного ввода/вывода МК: SPI, UART, I2C_
    - [workshop](./examples/part2/workshop/) - примеры, разобранные на практических занятиях
      - [ex1](./examples/part2/workshop/ex1) - пример решения практической задачи: _Язык программирования C_
      - [ex2](./examples/part2/workshop/ex2) - примеры решения четырех практических задач: _Включение светодиода_, _Включение светодиода по абсолютным адресам_,
            _Управление светодиода переключателем_, _Мигающий светодиод_
      - [ex3](./examples/part2/workshop/ex3) - примеры решения двух практических задач: _Чтение АЦП программным опросом_, _Антидребезг кнопки_
      - [ex4](./examples/part2/workshop/ex4) - примеры решения двух практических задач: _Внешние прерывания на портах ввода/вывода_, _Прерывание по окончанию преобразования АЦП_
      - [ex5](./examples/part2/workshop/ex5) - пример решения практической задачи: _Бегущий огонь_
      - [ex6](./examples/part2/workshop/ex6) - пример решения практической задачи: _Регулирование яркости светодиодов с помощью таймера_
      - [ex7](./examples/part2/workshop/ex7) - пример решения практических задач: _Управление светодиодами через UART_
      - [opt_ex1](./examples/part2/workshop/opt_ex1) - пример решения практической задачи: _Подключение датчика влажности по I2C_
      - [opt_ex2](./examples/part2/workshop/opt_ex2) - пример решения практической задачи: _Подключение внешней Flash памяти по SPI_
