...
- [Курс "Микропроцессорные устройства"](#курс-микропроцессорные-устройства)
  ...
  - [Структура курса](#структура-курса)
    - [Часть 1 Основы микропроцессорноый техники](#часть-1-основы-микропроцессорноый-техники)
    - [Часть 2 Микроконтроллер и периферийный модули](#часть-2-микроконтроллер-и-периферийный-модули)
    - [Лекции](#лекции)
...
### Часть 1 Основы микропроцессорноый техники
...
- Практические занятия
  ...
  - Практическое занятие №3: Подсистема прерываний МК ([пример](./examples/part2/workshop/ex3))
...
Порядок проведения занятий, темы занятий и их содержание могут отличаться от приведенного здесь на усмотрение преподавателя.
