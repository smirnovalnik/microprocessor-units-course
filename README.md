...
- Практические занятия
  ...
  - Практическое занятие №2: Порты ввода/вывода МК ([пример](./examples/part2/workshop/ex1))
  - Практическое занятие №3: Подсистема аналогового ввода/вывода МК ([пример](./examples/part2/workshop/ex2))
  ...
  - Дополнительное практическое занятие №1: Подсистема прерывания МК ([пример](./examples/part2/workshop/ex3))
  - Дополнительное практическое занятие №2: Подсистема последовательного ввода/вывода МК: SPI, I2C ([пример](./examples/part2/workshop/ex7))
- Лабораторные работы
