/**
  ...
  * \version 1.0.0
  * \date    1.01.2022
  * \brief   Шаблон программы на языке C и проекта для IDE Keil uVision 5.
  *          Проект полностью настроен для учебного стенда и содержит
  *          простейшую программу управления одним светодиодом.
  *          В верхнем положении ключа SW1 включается светодиод LED1,
  *          в нижнем светодиод LED1 выключается.
  *          Программа работает в режиме 0 учебного стенда (S1 = 0, S2 = 0).
  ******************************************************************************
  */

/* Подключение заголовочного файле с макроопределениями всех регистром специальных
   ...
   и Reference Manual). Кроме того, подключаеются функции CMSIS. */
#include <stm32f0xx.h>
